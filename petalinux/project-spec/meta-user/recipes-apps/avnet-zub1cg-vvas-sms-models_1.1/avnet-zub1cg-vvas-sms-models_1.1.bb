...
SRC_URI = " \
	file://models.b128/densebox_320_320/md5sum.txt \
	...
	file://models.b128/densebox_640_360/md5sum.txt \
	...
	file://models.b128/inception_v1/md5sum.txt \
	...
	file://models.b128/mobilenet_v2/md5sum.txt \
	...
	file://models.b128/refinedet_pruned_0_96/md5sum.txt \
	...
	file://models.b128/ssd_adas_pruned_0_95/md5sum.txt \
	...
	file://models.b128/ssd_mobilenet_v2/md5sum.txt \
	...
	file://models.b128/ssd_pedestrian_pruned_0_97/md5sum.txt \
	...
	file://models.b128/ssd_traffic_pruned_0_9/md5sum.txt \
	...
	file://models.b128/plate_detect/md5sum.txt \
	...
	file://models.b128/plate_num/md5sum.txt \
	...
	file://models.b128/yolov2_voc/md5sum.txt \
	...
	file://models.b128/yolov2_voc_pruned_0_77/md5sum.txt \
	...
	file://models.b128/yolov3_adas_pruned_0_9/md5sum.txt \
	...
	file://models.b128/yolov3_voc/md5sum.txt \
	...
	file://models.b128/yolov3_voc_tf/md5sum.txt \
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/densebox_320_320/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/densebox_640_360/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/inception_v1/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/mobilenet_v2/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/refinedet_pruned_0_96/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/resnet18/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/resnet50/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/ssd_adas_pruned_0_95/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/ssd_mobilenet_v2/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/ssd_pedestrian_pruned_0_97/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/ssd_traffic_pruned_0_9/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/plate_detect/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/plate_num/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/yolov2_voc/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/yolov2_voc_pruned_0_77/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/yolov3_adas_pruned_0_9/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/yolov3_voc/md5sum.txt"
...
FILES_${PN} += "/opt/avnet/zub1cg-vvas-sms/models.b128/yolov3_voc_tf/md5sum.txt"
